...
| F-04 | Independent model | MATLAB model | `matlab/VotingMachine.m`, `matlab/run_tests.m` | MATLAB runner | Required scenarios execute | Model updated for poll phases, accreditation, PIN lockout and post-close results; MATLAB/Octave unavailable on PATH | None | Blocked |
